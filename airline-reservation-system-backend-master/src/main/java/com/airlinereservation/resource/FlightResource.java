...
public class FlightResource {
	...
	public ResponseEntity<CommonApiResponse> addFlight(FlightRequestDto flightRequest) {
		...
		flight.setBusinessSeatsAvailable(airplane.getBusinessSeats());
		flight.setEconomySeatsAvailable(airplane.getEconomySeats());
		flight.setFirstClassSeatsAvailable(airplane.getFirstClassSeats());
